        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {isMaster && (
            <a
              ...
              className="inline-flex items-center gap-2 mt-5 px-5 py-2 rounded-full border border-selene-white/10 text-selene-white-dim text-xs hover:border-selene-gold/30 hover:text-selene-gold transition-all"
            >
