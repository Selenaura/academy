    ...
    <main className="min-h-screen bg-selene-bg text-selene-white">
      ...
      <section className="relative overflow-hidden py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {isMaster && (
            <a
              href="/master-brochure.pdf"
              download="Selene-Master-Guia-Espiritual-Profesional.pdf"
              className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-full border-2 border-selene-gold/40 bg-selene-gold/10 text-selene-gold text-sm font-medium hover:bg-selene-gold/20 hover:border-selene-gold/60 transition-all shadow-md shadow-selene-gold/10"
            >
