  ...
  return (
    <div className="min-h-screen bg-selene-bg">
      ...
      <section className="px-6 pb-8 max-w-[800px] mx-auto">
        <LeadCaptureForm
          source="web_argentina"
          headline="Descargá gratis: 5 errores que comete toda guía espiritual sin formación"
          subtext="Guía con datos reales (APA, neurociencia) sobre los riesgos de guiar sin método. Incluye lo que necesitás saber si ejercés en Argentina."
          country="ar"
        />
      </section>
      ...
      <section className="px-6 py-8 max-w-[800px] mx-auto">
        <LeadCaptureForm
          source="web_argentina_bottom"
          headline="¿Aún no te decidís? Empezá por la guía gratuita"
          subtext="Descubrí los 5 errores más comunes antes de invertir en tu formación. Es gratis y te va a ayudar a tomar una decisión informada."
          country="ar"
        />
      </section>
