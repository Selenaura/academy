...
export default function CookieConsent() {
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto rounded-2xl border border-[#2A2A35] bg-[#1C1F38] shadow-2xl shadow-black/60 p-5 sm:p-6">
        {/* Header text */}
        <p className="text-sm text-gray-300 leading-relaxed mb-4">
          ...
          <Link href="/cookies" className="text-[#9B8EC4] underline underline-offset-2 hover:brightness-110">
            Política de cookies
          </Link>
        </p>
        ...
        {showConfig && (
          <div className="mb-4 space-y-3">
            {/* Necessary - always on */}
            <div className="flex items-center justify-between rounded-lg border border-[#2A2A35] bg-[#0C0E1A] px-4 py-3">
              <div>
            ...
            {/* Analytics */}
            <label className="flex items-center justify-between rounded-lg border border-[#2A2A35] bg-[#0C0E1A] px-4 py-3 cursor-pointer">
              <div>
              ...
              <input
                ...
                className="w-5 h-5 rounded accent-[#9B8EC4] cursor-pointer"
              />
            </label>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          {!showConfig ? (
            <>
              ...
              <button
                onClick={acceptAll}
                className="flex-1 px-4 py-2.5 rounded-lg text-sm font-semibold bg-[#D4A843] text-[#0C0E1A] hover:brightness-110 transition"
              >
                Aceptar todo
              </button>
            </>
