...
const COHORT_DEADLINES = [
  { date: '2026-04-20T23:59:59', label: 'Edicion Primavera 2026' },
  { date: '2026-07-15T23:59:59', label: 'Edicion Verano 2026' },
  { date: '2026-10-01T23:59:59', label: 'Edicion Otono 2026' },
];
...
export default function CohortBanner() {
  ...
  if (!timeLeft || !cohort || dismissed) return null;
