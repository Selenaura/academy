...
export async function sendWelcomeEmail({ email, courseName, courseId, userName }) {
  const dashboardUrl = 'https://academia.selenaura.com/dashboard';
  const courseUrl = `https://academia.selenaura.com/curso/${courseId}`;
  const programUrl = courseId === 'guia-profesional'
    ? 'https://academia.selenaura.com/programa/guia-profesional'
    : courseUrl;
          ...
          <tr>
            <td style="padding:20px 40px 40px;text-align:center;">
              <p style="color:#6a6a7a;font-size:12px;line-height:1.6;margin:0;">
                ...
                <a href="https://academia.selenaura.com" style="color:#6a6a7a;">academia.selenaura.com</a>
                &nbsp;·&nbsp;
...
Selene Academia — academia.selenaura.com`;
          ...
          <tr>
            <td style="padding:20px 40px 40px;text-align:center;">
              <p style="color:#6a6a7a;font-size:12px;margin:0;">
                Selene Academia · <a href="https://academia.selenaura.com" style="color:#6a6a7a;">academia.selenaura.com</a>
              </p>
            </td>
          </tr>
        </table>
