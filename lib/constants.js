...
export const COURSES = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'ri-l1', title: '¿Qué son los patrones familiares invisibles?', duration: '16 min', type: 'video', module: 1 },
      { id: 'ri-l2', title: 'Teoría de Sistemas Familiares: de Bowen a la epigenética', duration: '18 min', type: 'video', module: 1 },
      { id: 'ri-l3', title: 'Las tres leyes sistémicas: pertenencia, orden y equilibrio', duration: '15 min', type: 'video', module: 1 },
      { id: 'ri-q1', title: 'Quiz: Fundamentos sistémicos', duration: '5 min', type: 'quiz', module: 1 },
      // Module 2: La carta natal como mapa familiar
      { id: 'ri-l4', title: 'Casa 4: tus raíces, tu hogar emocional', duration: '20 min', type: 'video', module: 2 },
      { id: 'ri-l5', title: 'Casa 8: herencias, transformación y secretos familiares', duration: '18 min', type: 'video', module: 2 },
      { id: 'ri-l6', title: 'Casa 12: el inconsciente colectivo familiar', duration: '17 min', type: 'video', module: 2 },
      { id: 'ri-q2', title: 'Quiz: Las casas familiares', duration: '5 min', type: 'quiz', module: 2 },
      // Module 3: Planetas de herencia
      { id: 'ri-l7', title: 'La Luna: tu herencia emocional materna', duration: '18 min', type: 'video', module: 3 },
      { id: 'ri-l8', title: 'Saturno: mandatos, límites y estructura heredada', duration: '16 min', type: 'video', module: 3 },
      { id: 'ri-l9', title: 'Los Nodos Lunares: karma generacional', duration: '20 min', type: 'video', module: 3 },
      ...
      { id: 'ri-l10', title: 'Epigenética: cómo el trauma se hereda biológicamente', duration: '18 min', type: 'video', module: 4 },
      { id: 'ri-l11', title: 'Lealtades invisibles: por qué repites lo que no viviste', duration: '15 min', type: 'video', module: 4 },
      { id: 'ri-l12', title: 'Ejercicio: tu genograma emocional', duration: '22 min', type: 'video', module: 4 },
      { id: 'ri-q4', title: 'Quiz: Herencia transgeneracional', duration: '5 min', type: 'quiz', module: 4 },
      // Module 5: Constelaciones y carta natal
      { id: 'ri-l13', title: 'Astrogenealogía: cuando la carta natal habla de tu familia', duration: '20 min', type: 'video', module: 5 },
      { id: 'ri-l14', title: 'Aspectos planetarios que revelan dinámicas familiares', duration: '18 min', type: 'video', module: 5 },
      { id: 'ri-l15', title: 'Práctica: lectura sistémica de tu propia carta', duration: '25 min', type: 'video', module: 5 },
      { id: 'ri-q5', title: 'Quiz: Astrogenealogía aplicada', duration: '5 min', type: 'quiz', module: 5 },
      // Module 6: Ejercicios de transformación
      { id: 'ri-l16', title: 'Movimientos sistémicos: ejercicios individuales guiados', duration: '22 min', type: 'video', module: 6 },
      { id: 'ri-l17', title: 'Ritual de reconexión: honrar tu linaje', duration: '18 min', type: 'video', module: 6 },
      { id: 'ri-l18', title: 'Práctica: carta de liberación a tu sistema familiar', duration: '20 min', type: 'video', module: 6 },
      { id: 'ri-q6', title: 'Quiz: Transformación sistémica', duration: '5 min', type: 'quiz', module: 6 },
      // Module 7: Relaciones y sistema actual
      { id: 'ri-l19', title: 'Cómo tus patrones familiares afectan tus relaciones', duration: '18 min', type: 'video', module: 7 },
      { id: 'ri-l20', title: 'Sinastría sistémica: tu pareja como espejo familiar', duration: '20 min', type: 'video', module: 7 },
      { id: 'ri-l21', title: 'Romper el ciclo: crear tu propio orden', duration: '16 min', type: 'video', module: 7 },
      { id: 'ri-q7', title: 'Quiz: Relaciones y sistema', duration: '5 min', type: 'quiz', module: 7 },
      // Module 8: Integración
      { id: 'ri-l22', title: 'Tu mapa completo: integrando carta natal + sistema familiar', duration: '22 min', type: 'video', module: 8 },
      { id: 'ri-l23', title: 'Plan de sanación sistémica personalizado', duration: '15 min', type: 'video', module: 8 },
      { id: 'ri-l24', title: 'Recursos, comunidad y próximos pasos', duration: '10 min', type: 'video', module: 8 },
