...
export const COURSES = [
  {
    ...
    lessons: [
      { id: 'b1-l1', title: '¿Qué es la espiritualidad consciente?', duration: '18 min', type: 'lesson', module: 1 },
      { id: 'b1-l2', title: 'No es fe ciega: es atención entrenada', duration: '12 min', type: 'lesson', module: 1 },
      { id: 'b1-l3', title: 'Tu cerebro como antena: neuroplasticidad', duration: '15 min', type: 'lesson', module: 1 },
      { id: 'b1-q1', title: 'Quiz: Fundamentos de consciencia', duration: '5 min', type: 'quiz', module: 1 },
      { id: 'b1-l4', title: 'Tu mapa cósmico — La carta natal', duration: '22 min', type: 'lesson', module: 2 },
      { id: 'b1-l5', title: 'Sol, Luna, Ascendente: tu triángulo', duration: '18 min', type: 'lesson', module: 2 },
      { id: 'b1-l6', title: 'Cronobiología: tu estación de nacimiento importa', duration: '14 min', type: 'lesson', module: 2 },
      { id: 'b1-q2', title: 'Quiz: Tu mapa cósmico', duration: '5 min', type: 'quiz', module: 2 },
      { id: 'b1-l7', title: 'Meditación y cerebro: la ciencia real', duration: '20 min', type: 'lesson', module: 3 },
      { id: 'b1-l8', title: 'MBSR: el protocolo con más evidencia', duration: '16 min', type: 'lesson', module: 3 },
      { id: 'b1-l9', title: 'Práctica guiada: tu primera meditación', duration: '15 min', type: 'lesson', module: 3 },
      { id: 'b1-q3', title: 'Quiz: Meditación basada en evidencia', duration: '5 min', type: 'quiz', module: 3 },
      { id: 'b1-l10', title: 'El péndulo interno: intuición vs. ego', duration: '15 min', type: 'lesson', module: 4 },
      { id: 'b1-l11', title: 'Señales del cuerpo: el eje intestino-cerebro', duration: '14 min', type: 'lesson', module: 4 },
      { id: 'b1-l12', title: 'Práctica: escucha tu intuición 7 días', duration: '10 min', type: 'lesson', module: 4 },
      { id: 'b1-q4', title: 'Quiz: Intuición entrenada', duration: '5 min', type: 'quiz', module: 4 },
      { id: 'b1-l13', title: 'Los 4 pilares del autoconocimiento', duration: '18 min', type: 'lesson', module: 5 },
      { id: 'b1-l14', title: 'Tu perfil energético: descúbrelo', duration: '20 min', type: 'lesson', module: 5 },
      { id: 'b1-l15', title: 'Práctica: mapa de energía personal', duration: '12 min', type: 'lesson', module: 5 },
      { id: 'b1-q5', title: 'Quiz: Autoconocimiento', duration: '5 min', type: 'quiz', module: 5 },
      { id: 'b1-l16', title: 'Tu hoja de ruta formativa', duration: '15 min', type: 'lesson', module: 6 },
      { id: 'b1-l17', title: 'Resumen: lo que has aprendido', duration: '10 min', type: 'lesson', module: 6 },
      { id: 'b1-l18', title: 'Recursos y próximos pasos', duration: '8 min', type: 'lesson', module: 6 },
